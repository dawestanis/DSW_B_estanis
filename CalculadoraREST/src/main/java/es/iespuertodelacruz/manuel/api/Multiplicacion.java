...
public class Multiplicacion {
	...
	public Response getMultiplicacion(@PathParam("numero1") String numero1, @PathParam("numero2") String numero2) {
		String resultado = "";
		try {
			double doubleNumero1 = Double.parseDouble(numero1);
			double doubleNumero2 = Double.parseDouble(numero2);
			Calculadora calculadora = new Calculadora(doubleNumero1, doubleNumero2, "multiplicacion");
