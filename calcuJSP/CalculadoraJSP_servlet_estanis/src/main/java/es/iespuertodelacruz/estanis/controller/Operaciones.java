 ...
 */
package es.iespuertodelacruz.estanis.controller;
...
public class Operaciones extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String operador = request.getParameter("operaciones");
        ...
        salida.println("<h1>Calculator!!</h1><br>");
        salida.println("<h2>El resultado de tu operacion es: " + CalcularResultado(num1, num2, operador) + "</h2>");
    ...
    public double CalcularResultado(double num1, double num2, String operador){
